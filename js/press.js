// Theme renderer. Canonical records live in content/press.js.
if (!window.siteContent) throw new Error('Shared content API must load before js/press.js');
const pressData = window.siteContent.press;
